  ...
  ({ className, type, icon, ...props }, ref) => {
    return (
      <div className="relative w-full">
        ...
        <div className="absolute inset-0 rounded-md pointer-events-none bg-gradient-to-r from-transparent via-primary/10 to-transparent opacity-0 transition-opacity duration-500 group-hover:opacity-100" />
      </div>
    )
  }
)
